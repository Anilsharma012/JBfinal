    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-16">
            ...
            <Card className="border-green-200 border-2 bg-green-50">
              <CardContent className="p-8 text-center">
                ...
                <div className="text-gray-600 space-y-1">
                  <p className="font-medium">Shiv Nagar, Gaddi Kheri Road</p>
                  <p>Opp. New IDC, Rohtak</p>
                  <p>Haryana, India</p>
                </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div
            className="bg-gray-300 h-96 rounded-lg flex items-center justify-center cursor-pointer hover:bg-gray-400 transition-colors"
            onClick={() =>
              window.open(
                "https://maps.google.com/?q=Plot+no.+107,+Gaddi+Khedi+Road,+HSIIDC+Industrial+Area,+Rohtak,+Haryana+124001,+India",
                "_blank",
          ...
          >
            <div className="text-center">
              ...
              <p className="text-gray-500 text-sm cursor-pointer hover:text-gray-700">
